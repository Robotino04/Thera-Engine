...
public:
     ...
     * @return PieceColor
     */
    constexpr PieceColor getColorToMove() const {
     ...
     * @return PieceColor
     */
    constexpr PieceColor getColorToNotMove() const {
     ...
     */
    constexpr BoardState const& getCurrentState() const {
        return currentState;
    }
     ...
     * @return Coordinate
     */
    constexpr Coordinate getEnPassantSquareForFEN() const {
     ...
     * @return Coordinate
     */
    constexpr Coordinate getEnPassantSquareToCapture() const {
     ...
     */
    constexpr bool hasEnPassant() const {
     ...
     */
    constexpr Bitboard& getBitboard(Piece piece) {
     ...
     * @return Bitboard the bitboard containing these pieces
     */
    constexpr Bitboard getBitboard(Piece piece) const {
        return currentState.pieceBitboards.at(piece.getRaw());
    }
     ...
     */
    constexpr Bitboard& getAllPieceBitboard() {
     ...
     * @return Bitboard the bitboard containing all pieces
     */
    constexpr Bitboard getAllPieceBitboard() const {
        return currentState.allPieceBitboard;
    }
     ...
     */
    constexpr uint64_t getCurrentHash() const {
     ...
     *
     * This is just for std::unordered_map to work. It completely ignores the actual equalness and thus avoids
     * any collisions. We can do this, since it is somewhat ok to use the wrong evaluation while searching.
     *
